...
function App() {
  ...
  return (
    <Router>
      {/* Pass only savedPathsCount */}
      <Navbar savedPathsCount={savedPaths.length} />
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            generatedPath && (
              <RoadmapView roadmap={generatedPath} onSave={handleSavePath} />
            )
          }
        />
        <Route
          ...
          element={
            <>
              <Dashboard
                savedPaths={savedPaths}
                onViewPath={(path) => setGeneratedPath(path)}
                onUpdateProgress={handleUpdateProgress}
              />
              <Footer />
            </>
        ...
        <Route
          ...
          element={
            <>
              <ChatInterface onRoadmapGenerated={setGeneratedPath} />
              <Footer />
            </>
          }
        />
